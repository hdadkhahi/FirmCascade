...
def cascade_rw(trX, trY, teX, teY, trX1, teX1, trX2, teX2, w_h1, w_o, b1, bo, plambda, a):
    ...
    for i, plambda in enumerate(lambda_vector):
        ...
        pygx_final = (1 - f(pygx1, a)) * pygx1 + (1 - f(pygx2, a)) * f(pygx1, a) * pygx2 + f(pygx1, a) * f(pygx2,
                                                                                                           a) * pygx
        ...
        updates = lasagne.updates.rmsprop(cost, params, learning_rate=0.4, rho=0.9, epsilon=1e-06)
